			...
			<React.Fragment>
				<div className="section about">
					<div className="section-container">
						...
						<h3>
							We are a community of students who collaborate, learn, and build kick-ass
							technical projects.
						</h3>
				...
				<div className="section events">
					<div className="section-container">
						...
						<div className="content left">
							...
							<p>
								PurdueHackers.com is a web application for Purdue Hackers to manage their
								members, events, and attendance. It also has the opportunity to provide
								useful features to the Purdue Hackers community, such as showcasing projects
								and helping students find team-mates for school, hackathon, and personal
								projects.
							</p>
							<h3>Mobile Apps</h3>
							<p>
								A lot of students have expressed interest in Purdue Hackers having an
								ios/android app. Purdue Hackers web application already provides the
								necessary accounts/data to serve users, we just need someone who can build
								these apps and hook them up to our current API.
							</p>
							<h3>Other Projects</h3>
							<p>
								There are tons of other development projects which Purdue Hackers organizes.
								This includes technical workshops, and events such as Purdue Hackers
								Battleship and Purdue Hackers Tron. Purdue Hackers is a community that is
								open to ideas for future events. If you have an idea, come to the next
								weekly PH Organizer Meeting and present it.
							</p>
						</div>
					...
					<div className="section-container">
						...
						<div className="list-group">
							<a
								...
								target="_blank"
							>
								<b>Project Github Repository:</b> The master repository. Fork your
								repository from here, and submit pull requests to push your code live.
							</a>
							<a
								rel="noopener noreferrer"
							...
							<a
								...
								target="_blank"
							>
								<b>Discord Group Chat:</b> General Purdue Hackers Open Organizer/WebDev
								Group Chat.
							</a>
						</div>
						<hr />
				...
				<div className="section">
					<div className="section-container">
						...
						<ul className="list-group">
							<li className="list-group-item">
								<b>frontend/src/actions</b>: Redux actions. Contains all async actions and
								has dispatchers to change global state of applications
							</li>
							<li className="list-group-item">
							...
							<li className="list-group-item">
								<b>frontend/src/reducers</b>: Contains all Redux action reducers, which
								modifies thier own substate based on what action is dispatched
							</li>
							<li className="list-group-item">
								<b>frontend/src/store</b>: Combines the redux reducers into one store and
								adds middleware
							</li>
							<li className="list-group-item">
							...
							<li className="list-group-item">
								<b>backend/src/config</b>: Sets up any global configurations into CONFIG
								global variable
							</li>
							<li className="list-group-item">
								<b>backend/src/middleware</b>: Defines any middleware to be used in the
								backend
							</li>
							<li className="list-group-item">
								<b>backend/src/models</b>: Various models (objects) which we use for
								manipulating and storing data in our database. (E.G. Each user who signs up
								has their own Member object)
							</li>
							<li className="list-group-item">
